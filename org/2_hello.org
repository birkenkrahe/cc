...
- There is a separate Org-mode file available for practice. Download
  ~2_hello_practice.org~ from GitHub: [[https://tinyurl.com/yckuhh2f][tinyurl.com/yckuhh2f]]
...
- If you /tangle/ [[hello2]] and compile the source file ~hello2.c~ in a
