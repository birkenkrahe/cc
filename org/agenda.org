...
- Friday: ~for~ loops
  ...
  #+end_example
* IN PROGRESS Week 15 - Arrays, Functions and Pointers
#+attr_latex: :width 400px
...
* DONE Test 7 preview - loop at your leisure
...
* DONE SURVEY - BONUS POINTS! DO IT NOW! PAYBACK TIME!
#+attr_latex: :width 400px
...
* DONE Last (bonus) assignments (practice files)
#+attr_latex: :width 400px
...
* DONE Review of arrays - freedom of flight
#+attr_latex: :width 400px
#+caption: Carter Buton early flight pioneer (flickr.com)
[[../img/arrays.jpg]]
