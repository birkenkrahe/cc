...
1) [ ] Where are Emacs error messages shown?
2) [ ] What does the Emacs modeline show?
3) [ ] How can you save an Emacs buffer? (how)
4) [ ] What do these abbreviations mean: ~<TAB>~ ~<RET>~ ~C-x~ ~M-q~
** IN PROGRESS Continue with the Emacs tutorial
#+attr_latex: :width 400px
[[../img/recover.png]]
