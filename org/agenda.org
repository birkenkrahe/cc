...
** IN PROGRESS Test 2 preview (more next week)
...
Done:
1) Downloaded a text file
2) Opened a no window Emacs on that file
3) Learnt how to insert files into a buffer
4) Understood editing buffer, the modeline and the minibuffer
5) Learnt how to auto-fill lines
6) Learnt how to add column mode
7) Learnt how to move forward, backward in the file
8) Learnt how to save a file

* Week 5
** TODO Hello World all over again
** TODO Programming assignment 1: your height in light-years
** NEW Online test 2: intro to C, hello Emacs
* References
