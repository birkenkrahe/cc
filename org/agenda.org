...
* IN PROGRESS Week 8 - C basics: naming/program layout
#+attr_latex: :width 400px
[[../img/midterm.png]]
...
- *Recap:* constants are important because? In C, there are 3 ways to
  define constants: with ~#define~ and with ~#include~ and with ~const~
* DONE Test 3 results - a mixed affair
#+attr_latex: :width 400px
...
* DONE You're lucky that this is only C
#+attr_latex: :width 400px
[[../img/java.png]]

Image: Java OOP program (Sedgewick/Wayne, Algorithms)

* TODO Bonus program 2 - Height in light-years "reloaded"
#+attr_latex: :width 400px
...
- Alter the last bonus program ([[https://github.com/birkenkrahe/cc/blob/piHome/org/bonus_pgm_1.org#solution][solution here]]) to accept height as input
...
* TODO Home assignment: constants/naming/layout
#+attr_latex: :width 400px
