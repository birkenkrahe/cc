...
* TODO Week 11 - Operators / Pseudocode / BPMN
#+attr_latex: :width 400px
#+caption: Stan Giddings, maintenance worker ascending Sydney Harbour Bridge, 18 September 1945, by Alec Iverson (Flickr.com)
[[../img/bridge.jpg]]

- [ ] Discussion: "Computational thinking" - what are your thoughts?
- [ ] Review and practice: logical operators
- [ ] Preview test 5: input/output/operators (Wednesday) - complete
  test no later than March 31 (open for partial credit until April 7).

* TODO Computational thinking? Who cares?
#+attr_latex: :width 400px
[[../img/rose.png]]
...
#+begin_quote
Computational thinking is [applied in] 33 areas:
...
1) What are some common mistakes when using ~printf~ and ~scanf~?
   #+begin_notes
   ~printf~
...
2) What does the format specifier ~%10.5f\n~ mean to you? What can you
   print with it?
   #+begin_src C :results output
     printf("....|....|....|\n");
     printf("%10.5f",3.141593);
   #+end_src

3) What if I want to print " or \ in C?
   #+begin_src C
     printf("The \" is printed using \\\"."); // \" is ", \\\" is \"
   #+end_src

4) You've met the ~main~ function. What does it do again?
   #+begin_notes
...
5) Can you rely on the compiler (~gcc~) to alert you if format
...
6) Which of these are operators in C?
   1) ++
   2) %%
   3) %
   4) !!
...
7) If ~int i = 10~ and ~int j = 500~, what will ~!(i > j)~ print in C?
...
8) What if there are arithmetic operators and characters present in
...
9) Test your ~scanf~ expertise: what does this command expect as input?
...
* TODO Review and practice: Logical values and operators
...
* TODO Week 12 - Conditional statements
* TODO Week 13 - Arrays
* TODO Week 14 - Functions
