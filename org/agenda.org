...
- [X] Declaring variables to the PC means "give me memory"
- [X] To declare floating point numbers, add ~f~: ~1.5f~
- [X] Example command: ~int x;~ declares ~x~ to be ~integer~
- [X] Assign a value to the declared variable: ~x=8;~
- [X] Printing with the ~printf~ function
- [X] ~printf("hello world");~ to print a string
- [X] To print ~x=8;~ use ~printf("%d\n",x)~
- [X] To print floating point numbers: ~%f~
...
** DONE Practice ~hello, world~ (file in GitHub)
** IN PROGRESS Variables (lecture + practice)
** TODO New test coming soon (deadline 24 Feb)
** TODO Don't forget to upload completed practice files
