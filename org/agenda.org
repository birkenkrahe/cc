...
* Week 6 - C fundamentals: variables
#+attr_latex: :width 400px
...
* Week 7 - C fundamentals: constants and I/O
#+attr_latex: :400px
[[../img/ccSP23test1_2.png]]

* IN PROGRESS REVIEW: variables PRACTICE
...
* NEXT Constants, input, naming and program layout
* TODO [[https://youtu.be/U3aXWizDbQ4][C in 100 seconds for the holidays]]
* DONE Assignment overview ([[https://lyon.instructure.com/courses/1014][Canvas]])
#+attr_latex: :width 400px
[[../img/assignments.png]]
...
* TODO Computing in light-years (a review with R)
#+attr_latex: :width 400px
[[../img/empirestatebuilding.jpg]]
- The constants (in scientific numeric notation):
  #+name: constants
  #+begin_src R
...
- Compute: How far does light travel in one year? (A derived constant)
  #+name: lightyear
  #+begin_src R
...
- Compute: How high is the Empire State Building (380m) in
  light-years?
  #+name: conversion
  #+begin_src R
  ...
  #+end_src
  The whole script can be tangled as ~convert.R~ and run on a shell like
  a C program with ~Rscript~ instead of the ~gcc~ compiler:
