...
- Friday: ~for~ loops
  ...
  #+end_example
* NEXT Week 15 - Arrays, Functions and Pointers
#+attr_latex: :width 400px
...
- Next week Monday last lecture: transition to C++

- Last meeting Wednesday: final exam pre-view (will include a few
  questions from the last week on arrays/pointers).

- PDF copies of all practice files will be online in GitHub today: if
  you want to complete them for partial credit, work through the PDFs.

* TODO Test 7 preview - loop loop loop
...
* TODO Review of arrays - freedom of flight
#+attr_latex: :width 400px
#+caption: Carter Buton early flight pioneer (flickr.com)
[[../img/arrays.jpg]]

* TODO Review of functions - dancing with tigers
#+attr_latex: :width 400px
#+caption: Myrtle Beach Safari program (Flickr.com)
[[../img/function.jpg]]

* TODO Review of pointers - the old reliable 
#+attr_latex: :width 400px
#+caption: Roadside stand near Birmingham, AL (LOC@flickr.com)
[[../img/pointer.jpg]]
* TODO Week 16 - C++ and final exam test
- [[https://youtu.be/MNeX4EGtR5Y][C++ in 100 seconds]]: whaddayaknow?
* TODO What next? (Further studies/career advice)
* References
