...
** TODO Test 2 review III
  ...
  - [ ] Which commands split the Emacs window?
  - [ ] Which command saves the Emacs buffer?
  - [ ] What kind of file is ~.emacs~?
  - [ ] 
  - [ ] What does "tangling" of an Org-mode file mean?
  - [ ] How does a minimal C program look like?
  - [ ] Can you explain this line of code?
    #+begin_example C
      printf("Hello again\n");
    #+end_example
  - [ ] What do ~#~, ~{~ and ~/*~ in source code mean?
