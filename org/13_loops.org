...
- Get the practice file in Emacs, write file and re-open as ~.org~:
  1) ~13_loops_while.org~ with ~M-x eww~ at [[https://bit.ly/cc_while][bit.ly/cc_while]]
  2) ~13_loops_for.org~ with ~M-x eww~ at [[https://bit.ly/cc_for][bit.ly/cc_for]]
  3) ~13_loops_do.org~ with ~M-x eww~ at [[https://bit.ly/cc_do_while][bit.ly/cc_do_while]] 
