...
| ~C-c C-v t~  | ~org-babel-tangle~ file[fn:3] |
...
* Footnotes
[fn:4] Alternatively, you can also open the file directly from the
...
[fn:2] You can change the ~fill-column~ value to any other value > 0.

[fn:3] This operation refers to extracting source code from a code
